...
export default function DateReminderFE() {
  ...
  const [noonTime, setNoonTime] = useState(null);
  ...
  const handleMorningDateChange = (event, selectedDate) => {
    ...
    // Calculate noon and night times based on the morning time selected
    const morningDateTime = new Date(currentDate);
    const noonDateTime = new Date(morningDateTime);
    const nightDateTime = new Date(morningDateTime);
    noonDateTime.setHours(noonDateTime.getHours() + 8); // 8 hours after morning
    nightDateTime.setHours(nightDateTime.getHours() + 16); // 16 hours after morning
    setNoonTime(formatTime(noonDateTime));
    setNightTime(formatTime(nightDateTime));
  };
  ...
  const setReminder = () => {
    ...
    if (!morningDate || !morningTime || !noonTime || !nightTime) {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Text style={styles.heading}>Three Times for a day</Text>

        <View style={styles.container3}>
          <Text style={styles.nrrText}>
          Please set <Text style={styles.specialBlue}> first time and date  </Text>
          </Text>
          <TextInput
        ...
        <View style={styles.container4}>
          <Text style={styles.nrrText}>
            Setting time for <Text style={styles.specialBlue}>Noon</Text>
          </Text>
          <TextInput
            style={styles.inputBox}
            placeholder=' Time'
        ...
        <View style={styles.container4}>
          <Text style={styles.nrrText}>
          Setting time for <Text style={styles.specialBlue}>Night</Text>
          </Text>
          <TextInput
            style={styles.inputBox}
            placeholder=' Time'
