...
export default function DateReminderFE() {
  ...
  const handleMorningDateChange = (event, selectedDate) => {
    ...
    noonDateTime.setHours(noonDateTime.getHours() + 12); // 8 hours after morning
  ...
  const setReminder = () => {
    ...
    if (!morningDate || !morningTime || !noonTime ) {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Text style={styles.heading}>Two times for a day</Text>
        ...
        <View style={styles.container4}>
          <Text style={styles.nrrText}>
            Setting time for <Text style={styles.specialBlue}>2nd time</Text>
          </Text>
          <TextInput
            style={styles.inputBox}
            placeholder=' Time'
